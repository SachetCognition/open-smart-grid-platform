  ...
  public ZonedDateTime convertTo(
    ...
    if (timeZone == null) {
      return ZonedDateTime.ofInstant(
          source.toGregorianCalendar().toInstant(), ZoneId.systemDefault());
    }
    return ZonedDateTime.ofInstant(source.toGregorianCalendar().toInstant(), timeZone);
  }

  private ZoneId timeZoneOf(final XMLGregorianCalendar source) {
