...
public class XMLGregorianCalendarToDateTimeConverterTest {
  ...
  public void mapXMLGregorianCalenderWithTimeZoneToDateTime()
    ...
    final ZonedDateTime mappedDateTime = this.mapper.map(xmlGregorianCalendar, ZonedDateTime.class);
    assertThat(mappedDateTime.toInstant()).isEqualTo(dateTime.toInstant());
  }
  ...
  public void mapXMLGregorianWithoutTimeZoneCalenderToDateTime()
    ...
    final ZonedDateTime mappedDateTime = this.mapper.map(xmlGregorianCalendar, ZonedDateTime.class);
    assertThat(mappedDateTime.toInstant()).isEqualTo(expected.toInstant());
  }
  ...
  public void mapStringToDateTime() {
    ...
    final ZonedDateTime mappedTime = this.mapper.map(stringTime, ZonedDateTime.class);
    assertThat(mappedTime)
        .withFailMessage("Not expecting NULL but a ZonedDateTime instance.")
        .isNotNull();
  }
