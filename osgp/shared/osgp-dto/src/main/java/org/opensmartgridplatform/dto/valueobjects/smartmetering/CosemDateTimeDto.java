...
public class CosemDateTimeDto implements Serializable, Comparable<CosemDateTimeDto> {
  ...
  private static int determineDeviation(final ZonedDateTime dateTime) {
    return -(dateTime.getOffset().getTotalSeconds() * 1000 / MILLISECONDS_PER_MINUTE);
  }
  ...
  public ZonedDateTime asDateTime() {
    ...
    final ZoneOffset zone = ZoneOffset.ofTotalSeconds(-this.deviation * 60);
  ...
  public LocalDateTime asLocalDateTime() {
    ...
    return LocalDateTime.of(
        ...
        this.time.getMinute(),
        this.time.getSecond(),
        this.time.getHundredths() * 10 * 1_000_000);
  }
