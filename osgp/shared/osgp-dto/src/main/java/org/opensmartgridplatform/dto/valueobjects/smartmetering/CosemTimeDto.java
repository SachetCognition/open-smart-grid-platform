...
public class CosemTimeDto implements Serializable, Comparable<CosemTimeDto> {
  ...
  public CosemTimeDto(final LocalTime time) {
    this(time.getHour(), time.getMinute(), time.getSecond(), time.getNano() / 10_000_000);
  }
  ...
  public LocalTime asLocalTime() {
    ...
    return LocalTime.of(this.hour, this.minute, this.second, this.hundredths * 10 * 1_000_000);
  }
